...
def _extract_asof(
    ...
    *,
    ...
    indicator_pipeline = _build_indicator_pipeline_impl(
        ...
        pre_idx=pre_idx,
        atr_period=atr_period,
        build_indicator_state_fn=lambda highs_arg, lows_arg, closes_arg, asof_bar_arg, pre_arg, pre_idx_arg, atr_period_arg: (
        ...
        build_base_feature_bundle_fn=lambda rsi_current_raw_arg, rsi_lag1_raw_arg, bb_last_3_arg, vol_shift_last_3_arg, vol_shift_current_arg, atr_window_56_arg, atr_vals_arg, atr14_current_arg: (
    ...
    features, fib_feature_status = _apply_fibonacci_feature_updates_impl(
        ...
        build_fibonacci_updates_fn=lambda highs_arg, lows_arg, closes_arg, atr_vals_arg, pre_arg, pre_idx_arg, timeframe_arg, asof_bar_arg, rsi_current_arg: (
            _build_fibonacci_updates_with_current_atr_period(
                highs_arg,
                lows_arg,
                closes_arg,
                atr_vals_arg,
